...
if CUDNN_PATH then
    ...
    local libnames = {'libcudnn.so.6', 'libcudnn.6.dylib', 'cudnn64_6.dll','libcudnn.so.5', 'libcudnn.5.dylib', 'cudnn64_5.dll'}
    local ok = false
    for i=1,#libnames do
...
if cudnn.version < 5005 or cudnn.version >= 7000 then
   error('These bindings are for CUDNN 5.x or 6.x (5005 >= cudnn.version < 7000) , '
